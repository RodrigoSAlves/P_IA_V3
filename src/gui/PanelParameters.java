...
import ga.geneticOperators.MutationUniform;
...
public class PanelParameters extends PanelAtributesValue {
    ...
    public MutationUniform<PredatorIndividual> getMutationMethod() {
        double mutationProbability = Double.parseDouble(jTextFieldProbMutation.getText());
        //COMPLETE?
        return new MutationUniform<>(mutationProbability/*COMPLETE?*/);
    }
